...
def html_input(text,input_type,name,style = "",text_style="",brake = True): # make a html <input>
    return "<h3 style=\"" + text_style + "display:inline-block;\">" + text + ": </h3><input type=\"" + input_type + "\" " + name + " style=\"" + style + "display:inline-block;\"" + "></input>" + ("<br/>" if brake else "")
